  ...
  return (
    <>
      <div className="ussage">
        <aside className="ussage__aside">
          <ul>
            <li><a href="#basicUssage">Basic ussage</a></li>
            <li><a href="#required&optional">Required & Optional Props</a></li>
            <li><a href="#requiredProps">Required Props List</a></li>
            <li><a href="#namingConventions">Naming Conventions</a></li>
            <li><a href="#naming&groupComponents">Naming & Group Components</a></li>
            <li><a href="#styling">Styling</a></li>
          </ul>
        </aside>
        <div className="ussage__content">
          <PageTitle pageTitle="How to use it" />
          <div className="ussage__section">
            <SectionTitle sectionTitle="Basic Ussage" id = "basicUssage" />
          ...
          <div className="ussage__section">
            <SectionTitle sectionTitle="Required & Optional Props" id="required&optional" />
            <p>
              Components take two kind of properties:{' '}
              <span className="ussage__headline">required and optional</span>{' '}
            </p>
            ...
            <SectionTitle sectionTitle="Required Props List" id = "requiredProps" />
            <table>
              <tr>
                <th>Component</th>
              ...
              <tr>
                ...
                <td>
                  links (an array of links => an array of string "linkUrl")
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  menuOptions{'(an array of options => an array of strings)'}
                </td>
              </tr>
              <tr>
                <td className="ussage__table-lineTitle">Shorthand</td>
                <td>
                  navbars{'(an array of links => link {(link, linkUrl)}'} and
                  type (to define the kind of shorthandMenu)
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  mediaUrls (array of links to media [ussually videos or
                  audios])
                </td>
              </tr>
            </table>
          </div>
          <SectionTitle sectionTitle="Naming conventions" id = "namingConventions" />
          ...
          <ul>
            ...
            <li className="ussage__rule">
              <div>
                <p className="ussage__rule-title">
                  Some names need a second suffix as clarification. That's the
                  case of: class, url, type
                </p>
              </div>
            </li>
            <li className="ussage__rule">
            ...
            <li className="ussage__rule">
              <p>
                ...
                A groupOfElements{' '}
                {'ie {ButtonGroup, ImageGroup, MediaPlayerGroup, ...}'} uses a
                word in plural
              </p>
              <Body body="A link has a single url:" />
              <Body body="{<Link linkUrl = {linkUrl} />}" bodyClass="code" />
          ...
          <div className="ussage__section">
            <SectionTitle sectionTitle="Naming & Group Components" id = "naming&groupComponents"/>
            ...
            <ul>
              <li>
                ...
                Style can be defined with GroupTitleClass
              </li>
              <li className="ussage__rule">
                {' '}
                <span className="ussage__headline">
              ...
              <li className="ussage__rule">
                ...
                That allows to style every component at once, and at the same
                time gives the flexibility to style distinctly one or more
                different component in a group{' '}
              </li>
            </ul>
          </div>
          <div className="ussage__section">
            <SectionTitle sectionTitle="Styling" id = "styling" />
            <p>Styling works through classes. Inline style is disregarded</p>
            <p>
              Every component in Neptune is already styled. That befrees you
              from write classes if no need to. At the same time you can
              overwrite default classes easily by passing the proper class rule
            </p>
            <Body
              body="{<Body body = `Default Class Body` />}"
              bodyClass="code"
            />
            <Body
